...
/**
 * The HttpAspPage interface describes the interaction that a JSP Page
 * Implementation Class must satisfy when using the HTTP protocol.
 *
 * <p>
 * The behaviour is identical to that of the AspPage, except for the signature
 * of the _aspService method, which is now expressible in the Java type
 * system and included explicitly in the interface.
 * 
 * @see AspPage
 */

public interface HttpAspPage extends AspPage {
     ...
     */
    public void _aspService(HttpServletRequest request,
