 ...
 * available to a tag handler. BodyContent is a subclass of AspWriter.
 * <p>
 ...
 * AspWriter (maybe another BodyContent object) following the structure of their
 * associated actions.
 * <p>
 ...
 */
public abstract class BodyContent extends AspWriter {

    /**
     * Protected constructor. Unbounded buffer, no autoflushing.
     * 
     * @param e
     *            the enclosing AspWriter
     */
    protected BodyContent(AspWriter e) {
    ...
    /**
     * Get the enclosing AspWriter.
     * 
     * @return the enclosing AspWriter passed at construction time
     */
    public AspWriter getEnclosingWriter() {
        return enclosingWriter;
    }

    // private fields

    private final AspWriter enclosingWriter;
}
