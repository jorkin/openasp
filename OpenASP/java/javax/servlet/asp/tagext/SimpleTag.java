 ...
 *
 * <p>To support body content, the <code>setAspBody()</code> 
 * method is provided.  The container invokes the <code>setAspBody()</code> 
 * method with a <code>AspFragment</code> object encapsulating the body of 
 ...
 *   <li>The <code>setAspContext()</code> and <code>setParent()</code> 
 ...
 *       by the container.</li>
 *   <li>If a body exists, the <code>setAspBody()</code> method is called 
 *       by the container to set the body of this tag, as a 
 *       <code>AspFragment</code>.  If the action element is empty in
 ...
 * @since 2.0
 */
public interface SimpleTag extends AspTag {
     ...
     * 
     * @throws javax.servlet.asp.AspException If an error occurred 
     ...
     */ 
    public void doTag() 
        throws javax.servlet.asp.AspException, java.io.IOException;
     ...
     * the <code>AspContext</code> for this invocation.
    ...
    /** 
     * Provides the body of this tag as a AspFragment object, able to be 
