...
/**
 * <p>
 * The actions and template data in a ASP page is written using the AspWriter
 ...
 * <B>Buffering</B>
 * <p>
 * The initial AspWriter object is associated with the PrintWriter object of the
 * ServletResponse in a way that depends on whether the page is or is not
 * buffered. If the page is not buffered, output written to this AspWriter
 ...
 */
public abstract class AspWriter extends java.io.Writer {
     ...
     * 
     * @param bufferSize
     *            the size of the buffer to be used by the AspWriter
     * @param autoFlush
     *            whether the AspWriter should be autoflushing
     */
    protected AspWriter(int bufferSize, boolean autoFlush) {
     ...
     * is written to the AspWriter's buffer or, if no buffer is used, directly
    ...
    /**
     * Print a character. The character is written to the AspWriter's buffer or,
     ...
     * AspWriter's buffer or, if no buffer is used, directly to the underlying
     * writer.
     * 
     * @param d
     ...
     * written to the AspWriter's buffer or, if no buffer is used, directly to
     ...
     * method is written to the AspWriter's buffer or, if no buffer is used,
     ...
     * <p>
     * This method needs not be invoked explicitly for the initial AspWriter as
    ...
    /**
     * This method returns the size of the buffer used by the AspWriter.
     * 
    ...
    /**
     * This method indicates whether the AspWriter is autoFlushing.
     * 
     * @return if this AspWriter is auto flushing or throwing IOExceptions on
    ...
    /**
     * The size of the buffer used by the AspWriter.
     */
    protected int bufferSize;

    /**
     * Whether the AspWriter is autoflushing.
     */
