...
/**
 * <p>
 * PageContext extends AspContext to provide useful context information for
 ...
 * AspFactory.getPageContext() method, and is released by calling
 * AspFactory.releasePageContext().
 *
 * <p> An example of how PageContext, AspFactory, and other classes can be
    ...
    extends AspContext
{
    ...
    public static final String PAGE = "javax.servlet.asp.aspPage";

    /**
     * Name used to store this PageContext in it's own name table.
     */

    public static final String PAGECONTEXT = "javax.servlet.asp.aspPageContext";

    /**
     * Name used to store ServletRequest in PageContext name table.
     */

    public static final String REQUEST = "javax.servlet.asp.aspRequest";

    /**
     * Name used to store ServletResponse in PageContext name table.
     */

    public static final String RESPONSE = "javax.servlet.asp.aspResponse";

    /**
     * Name used to store ServletConfig in PageContext name table.
     */

    public static final String CONFIG = "javax.servlet.asp.aspConfig";

    /**
     * Name used to store HttpSession in PageContext name table.
     */

    public static final String SESSION = "javax.servlet.asp.aspSession";
    /**
     * Name used to store current AspWriter in PageContext name table.
     */

    public static final String OUT = "javax.servlet.asp.aspOut";

    /**
     * Name used to store ServletContext in PageContext name table.
     */

    public static final String APPLICATION = "javax.servlet.asp.aspApplication";
    ...
    public static final String EXCEPTION = "javax.servlet.asp.aspException";
     ...
     * incoming request and response within it's _aspService() method.
     *
     * <p>
     * This method is typically called from AspFactory.getPageContext() in
     * order to initialize state.
     *
     * <p>
     * This method is required to create an initial AspWriter, and associate
     ...
     *     directive
     *
     * @throws IOException during creation of AspWriter
     ...
     * called from AspFactory.releasePageContext().
     *
     * <p>
     ...
     * executing within a <code> _aspService(...) </code> method of a JSP.
     * </p>
     * <p>
     ...
     * <code> _aspService(...) </code> after calling this method.
     * </p>
     *
     ...
     * </p>
     * <p>
     * The current AspWriter "out" for this JSP is flushed as a side-effect
     ...
     * ServletRequest and ServletResponse being processed by the calling Thread.
     * The output of the target resources processing of the request is written
     * directly to the current AspWriter returned by a call to getOut().
     * </p>
     * <p>
     * If flush is true, The current AspWriter "out" for this JSP 
     * is flushed as a side-effect of this call, prior to processing 
     * the include.  Otherwise, the AspWriter "out" is not flushed.
     * </p>
     * <p>
     * If the <i>relativeUrlPath</i> begins with a "/" then the URL specified
     * is calculated relative to the DOCROOT of the <code>ServletContext</code>
     ...
     * @param flush True if the AspWriter is to be flushed before the include,
     *     or false if not.
     *
     * @throws ServletException if the page that was forwarded to throws
     *     a ServletException
    ...
    /**
     * Return a new BodyContent object, save the current "out" AspWriter,
