...
import com.zfbots.openasp.util.modeler.Registry;
...
public class StandardContext extends ContainerBase
   ...
   /**
     ...
     */
    private com.zfbots.openasp.util.http.mapper.Mapper mapper = 
        new com.zfbots.openasp.util.http.mapper.Mapper();
    ...
    private AspConfigDescriptor aspConfigDescriptor =
        new ApplicationAspConfigDescriptor();
     ...
     */
    @Override
    public com.zfbots.openasp.util.http.mapper.Mapper getMapper() {
        return (mapper);
    }
    ...
    @Override
    public AspConfigDescriptor getAspConfigDescriptor() {
        return aspConfigDescriptor;
    }
    ...
    public void addChild(Container child) {
        ...
        boolean isAspServlet = "asp".equals(child.getName());

        // Allow webapp to override AspServlet inherited from global web.xml.
        if (isAspServlet) {
            oldAspServlet = (Wrapper) findChild("asp");
            if (oldAspServlet != null) {
                removeChild(oldAspServlet);
            }
        }

        super.addChild(child);

        if (isAspServlet && oldAspServlet != null) {
            /*
             * The webapp-specific AspServlet inherits all the mappings
             * specified in the global web.xml, and may add additional ones.
             */
            String[] aspMappings = oldAspServlet.findMappings();
            for (int i=0; aspMappings!=null && i<aspMappings.length; i++) {
                addServletMapping(aspMappings[i], child.getName());
            }
        }
    }
     ...
     * @param pattern URL pattern to be mapped
     * @param name Name of the corresponding servlet to execute
     * @param aspWildCard true if name identifies the AspServlet
    ...
    public void addServletMapping(String pattern, String name,
        ...
        mapper.addWrapper(decodedPattern, wrapper, aspWildCard,
    ...
    private void resetContext() throws Exception {
        ...
        aspConfigDescriptor = new ApplicationAspConfigDescriptor();
