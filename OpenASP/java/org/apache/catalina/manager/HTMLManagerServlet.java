...
public final class HTMLManagerServlet extends ManagerServlet {
    ...
    protected static final String sessionsListAspPath  = "/WEB-INF/asp/sessionsList.asp";
    protected static final String sessionDetailAspPath = "/WEB-INF/asp/sessionDetail.asp";
    ...
    protected void displaySessionsListPage(ContextName cn,
        ...
        getServletContext().getRequestDispatcher(sessionsListAspPath).include(req, resp);
    }
    ...
    protected void displaySessionDetailPage(HttpServletRequest req,
        ...
        getServletContext().getRequestDispatcher(resp.encodeURL(sessionDetailAspPath)).include(req, resp);
    }
    ...
    protected Comparator<Session> getComparator(String sortBy) {
        ...
        if ("CreationTime".equalsIgnoreCase(sortBy)) {
            ...
            comparator = new BaseSessionComparator<String>() {
                @Override
                public Comparable<String> getComparableObject(Session session) {
                    return AspHelper.guessDisplayLocaleFromSession(session);
                }
            };
            ...
            comparator = new BaseSessionComparator<String>() {
                @Override
                public Comparable<String> getComparableObject(Session session) {
                    return AspHelper.guessDisplayUserFromSession(session);
                }
            };
