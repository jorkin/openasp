 ...
 * @author Shawn Bayern
 */
public class AspRuntimeLibrary {
     ...
     * javax.servlet.asp.aspException request attribute value.
     *
   ...
   // __begin convertMethod
                                        ...
                                        throws JasperException
    {
                ...
                if (type.isArray()) {
                    if (request == null) {
                        throw new JasperException(
                            Localizer.getMessage("asp.error.beans.setproperty.noindexset"));
                    }
        ...
        if (!ignoreMethodNF && (method == null)) {
            if (type == null) {
                throw new JasperException(
                    Localizer.getMessage("asp.error.beans.noproperty",
                                         prop,
                                         bean.getClass().getName()));
            } else {
                throw new JasperException(
                    Localizer.getMessage("asp.error.beans.nomethod.setproperty",
                                         prop,
                                         type.getName(),
                                         bean.getClass().getName()));
            }
    ...
    throws JasperException {
        if (o == null) {
            throw new JasperException(
                    Localizer.getMessage("asp.error.beans.nullbean"));
        }
        Object value = null;
        try {
    ...
    // handles <asp:setProperty> with EL expression for 'value' attribute
...
**/
    ...
    throws JasperException {
        ...
        try {
            ...
            if ( info != null ) {
                ...
                throw new JasperException(
                    Localizer.getMessage("asp.error.beans.nobeaninfo",
                                         beanClass.getName()));
            }
        } catch (Exception ex) {
            throw new JasperException (ex);
    ...
    public static Method getReadMethod(Class<?> beanClass, String prop)
        ...
        if (method == null) {
            if (type == null) {
                throw new JasperException(
                    Localizer.getMessage("asp.error.beans.noproperty", prop,
                                         beanClass.getName()));
            } else {
                throw new JasperException(
                    Localizer.getMessage("asp.error.beans.nomethod", prop,
                                         beanClass.getName()));
            }
        }
        ...
        throws JasperException 
    {
        try {
            ...
            throw new JasperException(
                Localizer.getMessage("asp.error.beans.property.conversion",
        ...
        try {
            ...
            if (propEditor != null) {
                ...
                throw new IllegalArgumentException(
                    Localizer.getMessage("asp.error.beans.propertyeditor.notregistered"));
            }
