...
/**
 * Implementation of AspApplicationContext
 *
 * @author Jacob Hookom
 */
public class AspApplicationContextImpl implements AspApplicationContext {

    private static final String KEY = AspApplicationContextImpl.class.getName();
    ...
    public AspApplicationContextImpl() {
    ...
    public static AspApplicationContextImpl getInstance(ServletContext context) {
        if (context == null) {
            throw new IllegalArgumentException("ServletContext was null");
        }
        AspApplicationContextImpl impl = (AspApplicationContextImpl) context
                .getAttribute(KEY);
        if (impl == null) {
            impl = new AspApplicationContextImpl();
            context.setAttribute(KEY, impl);
        }
        return impl;
    }

    public ELContextImpl createELContext(AspContext context) {
        if (context == null) {
            throw new IllegalArgumentException("AspContext was null");
        }

        // create ELContext for AspContext
        ...
        ctx.putContext(AspContext.class, context);
