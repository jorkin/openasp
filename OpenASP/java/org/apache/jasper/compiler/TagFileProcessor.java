...
class TagFileProcessor {
    ...
    private static class TagFileDirectiveVisitor extends Node.Visitor {
        ...
        private static final AspUtil.ValidAttribute[] tagDirectiveAttrs = {
                new AspUtil.ValidAttribute("display-name"),
                new AspUtil.ValidAttribute("body-content"),
                new AspUtil.ValidAttribute("dynamic-attributes"),
                new AspUtil.ValidAttribute("small-icon"),
                new AspUtil.ValidAttribute("large-icon"),
                new AspUtil.ValidAttribute("description"),
                new AspUtil.ValidAttribute("example"),
                new AspUtil.ValidAttribute("pageEncoding"),
                new AspUtil.ValidAttribute("language"),
                new AspUtil.ValidAttribute("import"),
                new AspUtil.ValidAttribute("deferredSyntaxAllowedAsLiteral"), // JSP 2.1
                new AspUtil.ValidAttribute("trimDirectiveWhitespaces"), // JSP 2.1
                new AspUtil.ValidAttribute("isELIgnored") };

        private static final AspUtil.ValidAttribute[] attributeDirectiveAttrs = {
                new AspUtil.ValidAttribute("name", true),
                new AspUtil.ValidAttribute("required"),
                new AspUtil.ValidAttribute("fragment"),
                new AspUtil.ValidAttribute("rtexprvalue"),
                new AspUtil.ValidAttribute("type"),
                new AspUtil.ValidAttribute("deferredValue"),            // JSP 2.1
                new AspUtil.ValidAttribute("deferredValueType"),        // JSP 2.1
                new AspUtil.ValidAttribute("deferredMethod"),           // JSP 2
                new AspUtil.ValidAttribute("deferredMethodSignature"),  // JSP 21
                new AspUtil.ValidAttribute("description") };

        private static final AspUtil.ValidAttribute[] variableDirectiveAttrs = {
                new AspUtil.ValidAttribute("name-given"),
                new AspUtil.ValidAttribute("name-from-attribute"),
                new AspUtil.ValidAttribute("alias"),
                new AspUtil.ValidAttribute("variable-class"),
                new AspUtil.ValidAttribute("scope"),
                new AspUtil.ValidAttribute("declare"),
                new AspUtil.ValidAttribute("description") };
        ...
        public void visit(Node.TagDirective n) throws JasperException {
            ...
            AspUtil.checkAttributes("Tag directive", n, tagDirectiveAttrs, err);
            ...
            if (bodycontent != null
                ...
                err.aspError(n, "asp.error.tagdirective.badbodycontent",
                        bodycontent);
            }
        ...
        private String checkConflict(Node n, String oldAttrValue, String attr)
            ...
            if (attrValue != null) {
                if (oldAttrValue != null && !oldAttrValue.equals(attrValue)) {
                    err.aspError(n, "asp.error.tag.conflict.attr", attr,
        ...
        public void visit(Node.AttributeDirective n) throws JasperException {
            ...
            AspUtil.checkAttributes("Attribute directive", n,
            ...
            if (deferredValueString != null) {
                ...
                deferredValue = AspUtil.booleanValue(deferredValueString);
            }
            ...
            if (deferredValueType != null) {
                if (deferredValueSpecified && !deferredValue) {
                    err.aspError(n, "asp.error.deferredvaluetypewithoutdeferredvalue");
                } else {
                    deferredValue = true;
                }
            ...
            if (deferredMethodString != null) {
                ...
                deferredMethod = AspUtil.booleanValue(deferredMethodString);
            }
            ...
            if (deferredMethodSignature != null) {
                if (deferredMethodSpecified && !deferredMethod) {
                    err.aspError(n, "asp.error.deferredmethodsignaturewithoutdeferredmethod");
                } else {
                    deferredMethod = true;
                }
            ...
            if (deferredMethod && deferredValue) {
                err.aspError(n, "asp.error.deferredmethodandvalue");
            }
            
            String attrName = n.getAttributeValue("name");
            boolean required = AspUtil.booleanValue(n
            ...
            if (rtexprvalueString != null) {
                rtexprvalue = AspUtil.booleanValue(rtexprvalueString);
            }
            boolean fragment = AspUtil.booleanValue(n
                    .getAttributeValue("fragment"));
            String type = n.getAttributeValue("type");
            if (fragment) {
                // type is fixed to "AspFragment" and a translation error
                // must occur if specified.
                if (type != null) {
                    err.aspError(n, "asp.error.fragmentwithtype");
                }
                // rtexprvalue is fixed to "true" and a translation error
                // must occur if specified.
                rtexprvalue = true;
                if (rtexprvalueString != null) {
                    err.aspError(n, "asp.error.frgmentwithrtexprvalue");
                }
            } else {
                if (type == null)
            ...
            if (("2.0".equals(tagLibInfo.getRequiredVersion()) || ("1.2".equals(tagLibInfo.getRequiredVersion())))
                ...
                err.aspError("asp.error.invalid.version", path);
            }
        ...
        public void visit(Node.VariableDirective n) throws JasperException {
            ...
            AspUtil.checkAttributes("Variable directive", n,
            ...
            if (nameGiven == null && nameFromAttribute == null) {
                err.aspError("asp.error.variable.either.name");
            }

            if (nameGiven != null && nameFromAttribute != null) {
                err.aspError("asp.error.variable.both.name");
            }

            String alias = n.getAttributeValue("alias");
            if (nameFromAttribute != null && alias == null
                    || nameFromAttribute == null && alias != null) {
                err.aspError("asp.error.variable.alias");
            }
            ...
            if (declareStr != null)
                declare = AspUtil.booleanValue(declareStr);
        ...
        public TagInfo getTagInfo() throws JasperException {
            ...
            String tagClassName = AspUtil.getTagHandlerClassName(
        ...
        private void checkUniqueName(String name, String type, Node n,
            ...
            if (nameEntry != null) {
                if (!TAG_DYNAMIC.equals(type) ||
                    ...
                    err.aspError(n, "asp.error.tagfile.nameNotUnique", type,
        ...
        void postCheck() throws JasperException {
            ...
            while (iter.hasNext()) {
                ...
                if (nameEntry == null) {
                    err.aspError(nameFromNode,
                            "asp.error.tagfile.nameFrom.noAttribute", nameFrom);
                } else {
                    ...
                    if (!"java.lang.String".equals(tagAttr.getTypeName())
                        ...
                        err.aspError(nameFromNode,
                                "asp.error.tagfile.nameFrom.badAttribute",
    ...
    public static TagInfo parseTagFileDirectives(ParserController pc,
        ...
        try {
            ...
            err.aspError("asp.error.file.not.found", path);
        } catch (IOException e) {
            err.aspError("asp.error.file.not.found", path);
        }
    ...
    private Class<?> loadTagFile(Compiler compiler, String tagFilePath,
        ...
        AspCompilationContext ctxt = compiler.getCompilationContext();
        AspRuntimeContext rctxt = ctxt.getRuntimeContext();
        AspServletWrapper wrapper = rctxt.getWrapper(wrapperUri);

        synchronized (rctxt) {
            if (wrapper == null) {
                wrapper = new AspServletWrapper(ctxt.getServletContext(), ctxt
                        .getOptions(), tagFilePath, tagInfo, ctxt
                        .getRuntimeContext(), tagJarResouce);
                rctxt.addWrapper(wrapperUri, wrapper);

                // Use same classloader and classpath for compiling tag files
                wrapper.getAspEngineContext().setClassLoader(
                        ctxt.getClassLoader());
                wrapper.getAspEngineContext().setClassPath(ctxt.getClassPath());
            } else {
                // Make sure that AspCompilationContext gets the latest TagInfo
                // for the tag file. TagInfo instance was created the last
                // time the tag file was scanned for directives, and the tag
                // file may have been modified since then.
                wrapper.getAspEngineContext().setTagInfo(tagInfo);
            }
            ...
            try {
                if (tripCount > 0) {
                    ...
                    AspServletWrapper tempWrapper = new AspServletWrapper(ctxt
                            .getServletContext(), ctxt.getOptions(),
                            tagFilePath, tagInfo, ctxt.getRuntimeContext(),
                            ctxt.getTagFileJarResource(tagFilePath));
                    // Use same classloader and classpath for compiling tag files
                    tempWrapper.getAspEngineContext().setClassLoader(
                            ctxt.getClassLoader());
                    tempWrapper.getAspEngineContext().setClassPath(ctxt.getClassPath());
                    tagClazz = tempWrapper.loadTagFilePrototype();
                    tempVector.add(tempWrapper.getAspEngineContext()
                            .getCompiler());
                } else {
            ...
            try {
                ...
                if (tagIns instanceof AspSourceDependent) {
                    Iterator<Entry<String,Long>> iter = ((AspSourceDependent)
