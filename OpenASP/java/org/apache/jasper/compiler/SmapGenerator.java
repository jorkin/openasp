...
public class SmapGenerator {
    ...
    public static void main(String args[]) {
        ...
        s.addFile("foo.asp");
        s.addFile("bar.asp", "/foo/foo/bar.asp");
        s.addLineData(1, "foo.asp", 1, 1, 1);
        s.addLineData(2, "foo.asp", 1, 6, 1);
        s.addLineData(3, "foo.asp", 2, 10, 5);
        s.addLineData(20, "bar.asp", 1, 30, 1);
        g.addStratum(s, true);
        System.out.print(g);
