...
public class ErrorDispatcher {
    ...
    // Indicates whether the compilation was initiated by AspServlet or AspC
    private boolean aspcMode = false;


    /*
     * Constructor.
     *
     * @param aspcMode true if compilation has been initiated by AspC, false
     * otherwise
     */
    public ErrorDispatcher(boolean aspcMode) {
        // XXX check web.xml for custom error handler
        errHandler = new DefaultErrorHandler();
        this.aspcMode = aspcMode;
    }
     ...
     */
    public void aspError(String errCode) throws JasperException {
     ...
     * @param errCode Error code
     */
    public void aspError(Mark where, String errCode) throws JasperException {
     ...
     * @param errCode Error code
     */
    public void aspError(Node n, String errCode) throws JasperException {
     ...
     */
    public void aspError(String errCode, String arg) throws JasperException {
     ...
     * @param arg Argument for parametric replacement
     */
    public void aspError(Mark where, String errCode, String arg)
     ...
     * @param arg Argument for parametric replacement
     */
    public void aspError(Node n, String errCode, String arg)
                throws JasperException {
     ...
     */
    public void aspError(String errCode, String arg1, String arg2)
                throws JasperException {
     ...
     */
    public void aspError(String errCode, String arg1, String arg2, String arg3)
                throws JasperException {
     ...
     * @param arg2 Second argument for parametric replacement
     */
    public void aspError(Mark where, String errCode, String arg1, String arg2)
                throws JasperException {
    ...
    public void aspError(Node n, String errCode, String arg1, String arg2)
                throws JasperException {
     ...
     */
    public void aspError(Exception e) throws JasperException {
     ...
     * @param e Parsing exception
     */
    public void aspError(String errCode, String arg, Exception e)
                throws JasperException {
     ...
     * @param e Parsing exception
     */
    public void aspError(Node n, String errCode, String arg, Exception e)
                throws JasperException {
    ...
    private void dispatch(Mark where, String errCode, Object[] args,
        ...
        if (hasLocation) {
            errHandler.aspError(file, line, column, errMsg, nestedEx);
        } else {
            errHandler.aspError(errMsg, nestedEx);
        }
    }
    ...
    public static JavacErrorDetail createJavacError(String fname,
            Node.Nodes page, StringBuilder errMsgBuf, int lineNum,
            AspCompilationContext ctxt) throws JasperException {
        JavacErrorDetail javacError;
        // Attempt to map javac error line number to line in JSP page
        ErrorVisitor errVisitor = new ErrorVisitor(lineNum);
        page.visit(errVisitor);
        Node errNode = errVisitor.getAspSourceNode();
        if ((errNode != null) && (errNode.getStart() != null)) {
            ...
            if (errVisitor.getAspSourceNode() instanceof Node.Scriptlet) {
                javacError = new JavacErrorDetail(
                        fname,
                        lineNum,
                        errNode.getStart().getFile(),
                        errNode.getStart().getLineNumber() + lineNum -
                            errVisitor.getAspSourceNode().getBeginJavaLine(),
                        errMsgBuf,
                        ctxt);
            } else {
                javacError = new JavacErrorDetail(
