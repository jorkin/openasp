...
public class AntCompiler extends Compiler {
    ...
    protected void generateClass(String[] smap)
        ...
        try {
            ...
            be = e;
            log.error(Localizer.getMessage("asp.error.javac"), e);
            log.error(Localizer.getMessage("asp.error.javac.env") + info.toString());
        }
        ...
        if (be != null) {
            ...
            log.error(Localizer.getMessage("asp.error.compilation", javaFileName, errorReportString));
