...
class PageInfo {
    ...
    private HashMap<String, String> aspPrefixMapper;
    ...
    PageInfo(BeanRepository beanRepository, String aspFile, boolean isTagFile) {
        this.isTagFile = isTagFile;
        this.aspFile = aspFile;
        this.beanRepository = beanRepository;
        this.varInfoNames = new HashSet<String>();
        this.taglibsMap = new HashMap<String, TagLibraryInfo>();
        this.aspPrefixMapper = new HashMap<String, String>();
    ...
    public void addDependant(String d, Long lastModified) {
        if (!dependants.containsKey(d) && !aspFile.equals(d))
    ...
    public void setHasAspRoot(boolean s) {
        hasAspRoot = s;
    }

    public boolean hasAspRoot() {
        return hasAspRoot;
    }
    ...
    public void setIsAspPrefixHijacked(boolean isHijacked) {
        isAspPrefixHijacked = isHijacked;
    }

    public boolean isAspPrefixHijacked() {
        return isAspPrefixHijacked;
    }
    ...
    public void addPrefixMapping(String prefix, String uri) {
        aspPrefixMapper.put(prefix, uri);
    }
    ...
    public String getURI(String prefix) {
        ...
        LinkedList<String> stack = xmlPrefixMapper.get(prefix);
        if (stack == null || stack.size() == 0) {
            uri = aspPrefixMapper.get(prefix);
        } else {
            uri = stack.getFirst();
        }
    ...
    public void setLanguage(String value, Node n, ErrorDispatcher err,
        ...
        if (!"java".equalsIgnoreCase(value)) {
            if (pagedir)
                err.aspError(n, "asp.error.page.language.nonjava");
            else
                err.aspError(n, "asp.error.tag.language.nonjava");
        }
     ...
     * (org.apache.jasper.runtime.HttpAspBase) should be returned if this
     * attribute has not been set, FALSE otherwise
     *
     * @return The value of the 'extends' page directive attribute, or the
     * default (org.apache.jasper.runtime.HttpAspBase) if this attribute has
    ...
    public void setBufferValue(String value, Node n, ErrorDispatcher err)
        ...
        if ("none".equalsIgnoreCase(value))
            ...
            if (value == null || !value.endsWith("kb")) {
                if (n == null) {
                    err.aspError("asp.error.page.invalid.buffer");
                } else {
                    err.aspError(n, "asp.error.page.invalid.buffer");
                }
            }
            try {
    ...
    public void setSession(String value, Node n, ErrorDispatcher err)
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            err.aspError(n, "asp.error.page.invalid.session");
    ...
    public void setAutoFlush(String value, Node n, ErrorDispatcher err)
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            err.aspError(n, "asp.error.autoFlush.invalid");
    ...
    public void setIsThreadSafe(String value, Node n, ErrorDispatcher err)
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            err.aspError(n, "asp.error.page.invalid.isthreadsafe");
    ...
    public void setIsErrorPage(String value, Node n, ErrorDispatcher err)
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            err.aspError(n, "asp.error.page.invalid.iserrorpage");
    ...
    public void setIsELIgnored(String value, Node n, ErrorDispatcher err,
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            if (pagedir)
                err.aspError(n, "asp.error.page.invalid.iselignored");
            else
                err.aspError(n, "asp.error.tag.invalid.iselignored");
        }
    ...
    public void setDeferredSyntaxAllowedAsLiteral(String value, Node n, ErrorDispatcher err,
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            if (pagedir)
                err.aspError(n, "asp.error.page.invalid.deferredsyntaxallowedasliteral");
            else
                err.aspError(n, "asp.error.tag.invalid.deferredsyntaxallowedasliteral");
        }
    ...
    public void setTrimDirectiveWhitespaces(String value, Node n, ErrorDispatcher err,
        ...
        if ("true".equalsIgnoreCase(value))
            ...
            if (pagedir)
                err.aspError(n, "asp.error.page.invalid.trimdirectivewhitespaces");
            else
                err.aspError(n, "asp.error.tag.invalid.trimdirectivewhitespaces");
        }
