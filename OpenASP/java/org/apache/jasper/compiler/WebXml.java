...
public class WebXml {
    ...
    public WebXml(ServletContext ctxt) throws IOException {
        ...
        if (webXml != null) {
            ...
            systemId = com.zfbots.openasp.util.scan.Constants.MERGED_WEB_XML;
        }
            ...
            if (altDDName != null) {
                try {
                    ...
                    log.warn(Localizer.getMessage(
                            "asp.error.internal.filenotfound",
                            altDDName));
                }
            }
        }
        ...
        if (source == null) {
            ...
            if (uri == null) {
                log.warn(Localizer.getMessage(
                        "asp.error.internal.filenotfound", WEB_XML));
            } else {
                stream = uri.openStream();
                source = new InputSource(stream);
                systemId = uri.toExternalForm();
