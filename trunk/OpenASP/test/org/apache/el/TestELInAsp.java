 ...
 */
public class TestELInAsp extends TomcatBaseTest {
    ...
    public void testBug45451() throws Exception {
        ...
        res = getUrl("http://localhost:" + getPort() + "/test/bug45nnn/bug45451b.asp");
        result = res.toString();
        // Warning: JSP attribute escaping != Java String escaping
        ...
        res = getUrl("http://localhost:" + getPort() + "/test/bug45nnn/bug45451c.asp");
        result = res.toString();
        // Warning: JSP attribute escaping != Java String escaping
        ...
        res = getUrl("http://localhost:" + getPort() + "/test/bug45nnn/bug45451d.aspx");
        result = res.toString();
        // Warning: JSP attribute escaping != Java String escaping
        ...
        res = getUrl("http://localhost:" + getPort() + "/test/bug45nnn/bug45451e.asp");
        result = res.toString();
        // Warning: JSP attribute escaping != Java String escaping
        // Warning: Attributes are always unescaped before passing to the EL
        //          processor
