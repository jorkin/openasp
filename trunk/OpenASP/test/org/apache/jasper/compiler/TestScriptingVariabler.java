...
public class TestScriptingVariabler extends TomcatBaseTest {
    ...
    public void testBug42390() throws Exception {
        ...
        Exception e = null;
        try {
            getUrl("http://localhost:" + getPort() + "/test/bug42390.asp");
    ...
    public void testBug48616() throws Exception {
        ...
        Exception e = null;
        try {
            getUrl("http://localhost:" + getPort() + "/test/bug48nnn/bug48616.asp");
        } catch (IOException ioe) {
            e = ioe;
        }
    ...
    public void testBug48616b() throws Exception {
        ...
        Exception e = null;
        try {
            getUrl("http://localhost:" + getPort() + "/test/bug48nnn/bug48616b.asp");
        } catch (IOException ioe) {
            e = ioe;
        }
