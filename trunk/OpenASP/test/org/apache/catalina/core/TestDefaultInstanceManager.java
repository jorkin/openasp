...
public class TestDefaultInstanceManager extends TomcatBaseTest {
    ...
    public void testClassUnloading() throws Exception {
        ...
        getUrl("http://localhost:" + getPort() + "/test/annotations.asp");
        // Request a second JSP (again, no tag libraries etc.)
        getUrl("http://localhost:" + getPort() + "/test/bug36923.asp");
        ...
        getUrl("http://localhost:" + getPort() + "/test/bug51544.asp");
    ...
    private DefaultInstanceManager doClassUnloadingPrep() throws Exception {
        ...
        // Note: Min value for maxLoadedAsps is 2
        Tomcat.initWebappDefaults(ctxt);
        Wrapper w = (Wrapper) ctxt.findChild("asp");
        w.addInitParameter("maxLoadedAsps", "2");
