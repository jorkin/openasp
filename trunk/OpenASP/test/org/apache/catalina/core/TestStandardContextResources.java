...
public class TestStandardContextResources extends TomcatBaseTest {
    ...
    public void testResources() throws Exception {
        ...
        assertPageContains("/test/resourceA.asp",
                "<p>resourceA.asp in the web application</p>");
        assertPageContains("/test/resourceB.asp",
                "<p>resourceB.asp in resources.jar</p>");
        assertPageContains("/test/folder/resourceC.asp",
                "<p>resourceC.asp in the web application</p>");
        assertPageContains("/test/folder/resourceD.asp",
                "<p>resourceD.asp in resources.jar</p>");
        assertPageContains("/test/folder/resourceE.asp",
                "<p>resourceE.asp in the web application</p>");
        assertPageContains("/test/resourceG.asp",
                "<p>resourceG.asp in WEB-INF/classes</p>", 404);
    }
    ...
    public void testResourcesWebInfClasses() throws Exception {
        ...
        assertPageContains("/test/folder/resourceE.asp",
                "<p>resourceE.asp in the web application</p>");
        assertPageContains("/test/resourceG.asp",
                "<p>resourceG.asp in WEB-INF/classes</p>");
    }
    ...
    public void testResourcesAbsoluteOrdering() throws Exception {
        ...
        tomcat.start();
        assertPageContains("/test/getresource?path=/resourceF.asp",
        "<p>resourceF.asp in resources2.jar</p>");
        assertPageContains("/test/getresource?path=/resourceB.asp",
        "<p>resourceB.asp in resources.jar</p>");
        ...
        "<p>resourceF.asp in resources2.jar</p>");
        assertPageContains("/test/getresource?path=/resourceB.asp",
        "<p>resourceB.asp in resources2.jar</p>");
    ...
    public void testResources2() throws Exception {
        ...
        assertPageContains("/test/getresource?path=/resourceF.asp",
                "<p>resourceF.asp in resources2.jar</p>");
        assertPageContains("/test/getresource?path=/resourceA.asp",
                "<p>resourceA.asp in the web application</p>");
        assertPageContains("/test/getresource?path=/resourceB.asp",
                "<p>resourceB.asp in resources.jar</p>");
        assertPageContains("/test/getresource?path=/folder/resourceC.asp",
                "<p>resourceC.asp in the web application</p>");
        assertPageContains("/test/getresource?path=/folder/resourceD.asp",
                "<p>resourceD.asp in resources.jar</p>");
        assertPageContains("/test/getresource?path=/folder/resourceE.asp",
                "<p>resourceE.asp in the web application</p>");
    }
