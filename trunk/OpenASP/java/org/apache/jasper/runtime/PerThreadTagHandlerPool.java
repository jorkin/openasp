...
public class PerThreadTagHandlerPool extends TagHandlerPool {
     ...
     *
     * @throws AspException if a tag handler cannot be instantiated
     */
    @Override
    public Tag get(Class<? extends Tag> handlerClass) throws AspException {
        ...
        if(ptd.current >=0 ) {
            ...
            try {
                ...
                throw new AspException(e.getMessage(), e);
            }
        }
    }
