...
public class PageContextImpl extends PageContext {
    ...
    private static final AspFactory aspf = AspFactory.getDefaultFactory(); 
    ...
    private AspApplicationContextImpl applicationContext;
    ...
    private transient AspWriter out;

    private transient AspWriterImpl baseOut;
    ...
    private void _initialize(Servlet servlet, ServletRequest request,
        ...
        this.applicationContext = AspApplicationContextImpl.getInstance(context);
        ...
        if (this.baseOut == null) {
            this.baseOut = new AspWriterImpl(response, bufferSize, autoFlush);
        } else {
    ...
    public void release() {
        ...
        try {
            if (isIncluded) {
                ((AspWriterImpl) out).flushBuffer();
                // push it into the including aspWriter
            } else {
                // Old code:
                // out.flush();
            ...
            IllegalStateException ise = new IllegalStateException(Localizer.getMessage("asp.error.flush"), ex);
            throw ise;
        } finally {
            servlet = null;
            config = null;
        ...
        case SESSION_SCOPE:
            if (session == null) {
                throw new IllegalStateException(Localizer
                        .getMessage("asp.error.page.noSession"));
            }
    ...
    public Exception getException() {
        Throwable t = AspRuntimeLibrary.getThrowable(request);

        // Only wrap if needed
        if ((t != null) && (!(t instanceof Exception))) {
            t = new AspException(t);
        }
    ...
    private void doInclude(String relativeUrlPath, boolean flush)
            throws ServletException, IOException {
        AspRuntimeLibrary.include(request, response, relativeUrlPath, out,
                flush);
    }
    ...
    private void doForward(String relativeUrlPath) throws ServletException,
        ...
        try {
            ...
            IllegalStateException ise = new IllegalStateException(Localizer
                    .getMessage("asp.error.attempt_to_clear_flushed_buffer"));
            ise.initCause(ex);
            throw ise;
        }
    ...
    private void doHandlePageException(Throwable t) throws IOException,
        ...
        if (errorPageURL != null && !errorPageURL.equals("")) {
            ...
            if (t instanceof AspException) {
                rootCause = ((AspException) t).getCause();
    ...
    public static Object proprietaryEvaluate(final String expression,
            ...
            throws ELException {
        Object retValue;
        final ExpressionFactory exprFactory = aspf.getAspApplicationContext(pageContext.getServletContext()).getExpressionFactory();
        if (SecurityUtil.isPackageProtectionEnabled()) {
            try {
