 ...
 */
public class AspWriterImpl extends AspWriter {
     ...
     */
    public AspWriterImpl(ServletResponse response) {
     ...
     */
    public AspWriterImpl(ServletResponse response, int sz, 
            boolean autoFlush) {
        super(sz, autoFlush);
        if (sz < 0)
    ...
    public final void clear() throws IOException {
        if ((bufferSize == 0) && (out != null))
            ...
            throw new IllegalStateException(
                    getLocalizeMessage("asp.error.ise_on_clear"));
        if (flushed)
            throw new IOException(
                    getLocalizeMessage("asp.error.attempt_to_clear_flushed_buffer"));
        ensureOpen();
        nextChar = 0;
    }
    ...
    private final void bufferOverflow() throws IOException {
        throw new IOException(getLocalizeMessage("asp.error.overflow"));
    }
