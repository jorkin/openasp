 ...
 *
 * @version $Id: UTF8Reader.java 1081765 2011-03-15 13:10:33Z markt $
 */
public class UTF8Reader
    ...
    public void mark(int readAheadLimit) throws IOException {
        throw new IOException(
                Localizer.getMessage("asp.error.xml.operationNotSupported",
                                     "mark()", "UTF-8"));
    }
    ...
    private void expectedByte(int position, int count)
        ...
        throw new UTFDataFormatException(
                Localizer.getMessage("asp.error.xml.expectedByte",
    ...
    private void invalidByte(int position, int count) 
        ...
        throw new UTFDataFormatException(
                Localizer.getMessage("asp.error.xml.invalidByte",
                                     Integer.toString(position),
                                     Integer.toString(count)));
    }
    ...
    private void invalidSurrogate(int uuuuu) throws UTFDataFormatException {
        ...
        throw new UTFDataFormatException(
                Localizer.getMessage("asp.error.xml.invalidHighSurrogate",
