 ...
 * @author Jacob Hookom
 */
public final class AspValueExpression extends ValueExpression implements
        Externalizable {
    ...
    public AspValueExpression() {
        super();
    }

    public AspValueExpression(String mark, ValueExpression target) {
        this.target = target;
        this.mark = mark;
    }
    ...
    public Class<?> getType(ELContext context) throws NullPointerException,
        ...
        try {
            ...
            if (e instanceof AspPropertyNotFoundException) throw e;
            throw new AspPropertyNotFoundException(this.mark, e);
        } catch (ELException e) {
            if (e instanceof AspELException) throw e;
            throw new AspELException(this.mark, e);
        }
    }
    ...
    public void setValue(ELContext context, Object value)
        ...
        try {
            ...
            if (e instanceof AspPropertyNotWritableException) throw e;
            throw new AspPropertyNotWritableException(this.mark, e);
        } catch (PropertyNotFoundException e) {
            if (e instanceof AspPropertyNotFoundException) throw e;
            throw new AspPropertyNotFoundException(this.mark, e);
        } catch (ELException e) {
