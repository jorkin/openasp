...
public class TldLocationsCache {
    ...
    private synchronized void init() throws JasperException {
        ...
        try {
            ...
            throw new JasperException(Localizer.getMessage(
                    "asp.error.internal.tldinit", ex.getMessage()), ex);
        }
    }
    ...
    private void tldScanWebXml() throws Exception {
        ...
        try {
            ...
            // Allow taglib to be an element of the root or asp-config (JSP2.0)
            TreeNode aspConfig = webtld.findChild("asp-config");
            if (aspConfig != null) {
                webtld = aspConfig;
            }
