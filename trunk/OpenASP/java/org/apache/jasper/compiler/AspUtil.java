...
public class AspUtil {
    ...
    public static void checkScope(String scope, Node n, ErrorDispatcher err)
        ...
        if (scope != null && !scope.equals("page") && !scope.equals("request")
            ...
            err.aspError(n, "asp.error.invalid.scope", scope);
        }
    }
     ...
     * attributes as well as attributes specified using the asp:attribute
     * standard action.
     */
    public static void checkAttributes(String typeOfTag, Node n,
        ...
        // Add names of attributes specified using asp:attribute
            ...
            for (int i = 0; i < numSubElements; i++) {
                ...
                if (node instanceof Node.NamedAttribute) {
                    ...
                    if (n.getAttributeValue(attrName) != null) {
                        err.aspError(n,
                                "asp.error.duplicate.name.aspattribute",
                                attrName);
                    }
                } else {
        ...
        if (!valid) {
            err.aspError(start, "asp.error.mandatory.attribute", typeOfTag,
                    missingAttribute);
        }
        ...
        for (int j = 0; j < attrLeftLength; j++) {
            ...
            if (!valid) {
                err.aspError(start, "asp.error.invalid.attribute", typeOfTag,
                        attribute);
            }
        }
    ...
    public static String interpreterCall(boolean isTagFile, String expression,
        ...
        String aspCtxt = null;
        if (isTagFile) {
            aspCtxt = "this.getAspContext()";
        } else {
            aspCtxt = "_aspx_page_context";
        }
        ...
        StringBuilder call = new StringBuilder(
                "("
                        ...
                        + ".class, " + "(javax.servlet.asp.PageContext)" + aspCtxt + ", "
                        + fnmapvar + ", " + XmlEscape + ")");
    ...
    public static String coerceToPrimitiveBoolean(String s,
        ...
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToBoolean("
                    + s + ")";
        } else {
    ...
    public static String coerceToBoolean(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Boolean) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveByte(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToByte("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(byte) 0";
    ...
    public static String coerceToByte(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Byte) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToChar(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToChar("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(char) 0";
    ...
    public static String coerceToCharacter(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Character) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveDouble(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToDouble("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(double) 0";
    ...
    public static String coerceToDouble(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Double) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
                    + s + ", Double.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveFloat(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToFloat("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(float) 0";
    ...
    public static String coerceToFloat(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Float) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToInt(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToInt("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "0";
    ...
    public static String coerceToInteger(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Integer) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveShort(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToShort("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(short) 0";
    ...
    public static String coerceToShort(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Short) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveLong(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "org.apache.jasper.runtime.AspRuntimeLibrary.coerceToLong("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(long) 0";
    ...
    public static String coerceToLong(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Long) org.apache.jasper.runtime.AspRuntimeLibrary.coerce("
    ...
    public static InputStream getInputStream(String fname, JarFile jarFile,
            AspCompilationContext ctxt, ErrorDispatcher err)
        ...
        if (jarFile != null) {
            ...
            if (jarEntry == null) {
                throw new FileNotFoundException(Localizer.getMessage(
                        "asp.error.file.not.found", fname));
            }
    ...
    public static String getTagHandlerClassName(String path, String urn,
        ...
        if (index == -1) {
            err.aspError("asp.error.tagfile.badSuffix", path);
        }
    ...
    static InputStreamReader getReader(String fname, String encoding,
            JarFile jarFile, AspCompilationContext ctxt, ErrorDispatcher err)
            throws JasperException, IOException {
    ...
    static InputStreamReader getReader(String fname, String encoding,
        ...
        try {
            ...
            err.aspError("asp.error.unsupported.encoding", encoding);
        }
