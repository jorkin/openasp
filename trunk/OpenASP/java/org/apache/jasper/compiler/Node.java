...
import javax.servlet.asp.tagext.BodyTag;
import javax.servlet.asp.tagext.DynamicAttributes;
import javax.servlet.asp.tagext.IterationTag;
import javax.servlet.asp.tagext.AspIdConsumer;
import javax.servlet.asp.tagext.SimpleTag;
...
import javax.servlet.asp.tagext.TryCatchFinally;
...
abstract class Node implements TagConstants {
     ...
     * are generated. For instance, for <asp:body> in foo.asp, this is
     * "foo_aspHelper". This is primarily used for communicating such info from
     ...
     * The location of the asp page @param parent The enclosing node
     */
     ...
     * attribute of the node, or from a asp:attrbute
     */
    ...
    /**
     * Searches all subnodes of this node for asp:attribute standard actions
     ...
     * 
     * @return Possibly empty Node.Nodes object containing any asp:attribute
        ...
        if (nodes != null) {
            ...
            for (int i = 0; i < numChildNodes; i++) {
                ...
                if (n instanceof NamedAttribute) {
                    ...
                    // Nothing can come before asp:attribute, and only
                    // asp:body can come after it.
                    break;
                }
            }
        }
    ...
    /**
     * Represents the root of a Asp page or Asp document
     */
    public static class Root extends Node {
        ...
        private String aspConfigPageEnc;
         ...
         */
        public void setAspConfigPageEncoding(String enc) {
            aspConfigPageEnc = enc;
        }
         ...
         * pattern matches the page containing this Root.
         */
        public String getAspConfigPageEncoding() {
            return aspConfigPageEnc;
        }
    ...
    /**
     * Represents the root of a Asp document (XML syntax)
     */
    public static class AspRoot extends Node {

        public AspRoot(String qName, Attributes attrs,
    ...
    /**
     * Represents a <asp:invoke> tag file action
     */
    ...
    /**
     * Represents a <asp:doBody> tag file action
     */
    ...
    /**
     * Represents a Asp comment Comments are kept for completeness.
     */
    ...
    public static class ParamAction extends Node {
        ...
        public void setValue(AspAttribute value) {
            this.value = value;
        }

        public AspAttribute getValue() {
            return value;
        }
    }
    ...
    public static class IncludeAction extends Node {
        ...
        public void setPage(AspAttribute page) {
            this.page = page;
        }

        public AspAttribute getPage() {
            return page;
        }
    }
    ...
    public static class UseBean extends Node {
        ...
        public void setBeanName(AspAttribute beanName) {
            this.beanName = beanName;
        }

        public AspAttribute getBeanName() {
            return beanName;
        }
    }
    ...
    public static class PlugIn extends Node {
        ...
        private AspAttribute width;

        private AspAttribute height;
        ...
        public void setHeight(AspAttribute height) {
            this.height = height;
        }

        public void setWidth(AspAttribute width) {
            this.width = width;
        }

        public AspAttribute getHeight() {
            return height;
        }

        public AspAttribute getWidth() {
            return width;
        }
    }

    /**
     * Represents an uninterpreted tag, from a Asp document
     */
    public static class UninterpretedTag extends Node {

        private AspAttribute[] aspAttrs;
        ...
        public void setAspAttributes(AspAttribute[] aspAttrs) {
            this.aspAttrs = aspAttrs;
        }

        public AspAttribute[] getAspAttributes() {
            return aspAttrs;
        }
    }

    /**
     * Represents a <asp:element>.
     */
    public static class AspElement extends Node {

        private AspAttribute[] aspAttrs;

        private AspAttribute nameAttr;

        public AspElement(Attributes attrs, Mark start, Node parent) {
            this(JSP_ELEMENT_ACTION, attrs, null, null, start, parent);
        }

        public AspElement(String qName, Attributes attrs,
                Attributes nonTaglibXmlnsAttrs, Attributes taglibAttrs,
                Mark start, Node parent) {
         ...
         */
        public void setNameAttribute(AspAttribute nameAttr) {
         ...
         */
        public AspAttribute getNameAttribute() {
            return this.nameAttr;
        }
    }

    /**
     * Represents a <asp:output>.
     */
    public static class AspOutput extends Node {

        public AspOutput(String qName, Attributes attrs,
                Attributes nonTaglibXmlnsAttrs, Attributes taglibAttrs,
                Mark start, Node parent) {
     ...
     * AspBody, and NamedAttribute. The information is set in the Collector.
     */
    ...
    public static class CustomTag extends Node {
        ...
        private boolean implementsAspIdConsumer;
        ...
        public CustomTag(String qName, String prefix, String localName,
            ...
            this.implementsDynamicAttributes = DynamicAttributes.class
                    .isAssignableFrom(tagHandlerClass);
            this.implementsAspIdConsumer = AspIdConsumer.class
                    .isAssignableFrom(tagHandlerClass);
        }
        ...
        public CustomTag(String qName, String prefix, String localName,
            ...
            this.implementsAspIdConsumer = false;
        ...
        public boolean implementsAspIdConsumer() {
            return implementsAspIdConsumer;
        }
         ...
         * AspFragment.
         */
        public boolean checkIfAttributeIsAspFragment(String name) {
         ...
         * asp:attribute actions, or - the action's asp:body is empty.
         */
    ...
    /**
     * Represents the body of a &lt;asp:text&gt; element
     */
    public static class AspText extends Node {

        public AspText(String qName, Attributes nonTaglibXmlnsAttrs,
                Attributes taglibAttrs, Mark start, Node parent) {
    ...
    /**
     * Represents a Named Attribute (&lt;asp:attribute&gt;)
     */
    public static class NamedAttribute extends Node {
        ...
        // used with a <asp:element>, otherwise false
        private AspAttribute omit;
        ...
        public void setOmit(AspAttribute omit) {
            this.omit = omit;
        }
        
        public AspAttribute getOmit() {
            return omit;
        }
        ...
        /*
         * Get the attribute value from this named attribute (<asp:attribute>).
         * Since this method is only for attributes that are not rtexpr, we can
         * assume the body of the asp:attribute is a template text.
         */
        @Override
        public String getText() {
            ...
            // According to JSP 2.0, if the body of the <asp:attribute>
    ...
    /**
     * Represents a AspBody node (&lt;asp:body&gt;)
     */
    public static class AspBody extends Node {

        private ChildInfo childInfo;

        public AspBody(Mark start, Node parent) {
            this(JSP_BODY_ACTION, null, null, start, parent);
        }

        public AspBody(String qName, Attributes nonTaglibXmlnsAttrs,
                Attributes taglibAttrs, Mark start, Node parent) {
     ...
     * asp:attribute standard action).
     */

    public static class AspAttribute {
        ...
        /**
         * Use this constructor if the AspAttribute represents a named
         * attribute. In this case, we have to store the nodes of the body of
         * the attribute.
         */
        AspAttribute(NamedAttribute na, TagAttributeInfo tai, boolean dyn) {
    ...
    public static class Visitor {
        ...
        public void visit(AspRoot n) throws JasperException {
            doVisit(n);
            visitBody(n);
        }
        ...
        public void visit(AspElement n) throws JasperException {
            doVisit(n);
            visitBody(n);
        }

        public void visit(AspText n) throws JasperException {
            doVisit(n);
            visitBody(n);
        }
        ...
        public void visit(AspBody n) throws JasperException {
            doVisit(n);
            visitBody(n);
        }
        ...
        public void visit(AspOutput n) throws JasperException {
            doVisit(n);
        }
