...
final class Mark {
     ...
     * Constructor
     *
     * @param reader AspReader this mark belongs to
     * @param inStream current stream for this mark
     * @param fileId id of requested asp file
     * @param name JSP file name
     * @param inBaseDir base directory of requested asp file
     * @param inEncoding encoding of current file
     */
    Mark(AspReader reader, char[] inStream, int fileId, String name,
         String inBaseDir, String inEncoding) {

        this.reader = reader;
        this.ctxt = reader.getAspCompilationContext();
     ...
     * Constructor
     */    
    Mark(AspCompilationContext ctxt, String filename, int line, int col) {
