...
public class TagPluginManager {
    ...
    private void init(ErrorDispatcher err) throws JasperException {
        ...
        if (!TAG_PLUGINS_ROOT_ELEM.equals(root.getName())) {
            err.aspError("asp.error.plugin.wrongRootElement", TAG_PLUGINS_XML,
    ...
    static class TagPluginContextImpl implements TagPluginContext {
        ...
        public boolean isConstantAttribute(String attribute) {
            Node.AspAttribute attr = getNodeAttribute(attribute);
            if (attr == null)
                return false;
        ...
        private Node.AspAttribute getNodeAttribute(String attribute) {
            Node.AspAttribute[] attrs = node.getAspAttributes();
