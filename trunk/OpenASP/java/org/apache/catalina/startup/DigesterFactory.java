...
public class DigesterFactory {
    ...
    protected static void registerLocalSchema(SchemaResolver schemaResolver){
        ...
        // JSP
        register(Constants.AspSchemaResourcePath_20,
                 Constants.AspSchemaPublicId_20,
                 schemaResolver);

        register(Constants.AspSchemaResourcePath_21,
                Constants.AspSchemaPublicId_21,
                schemaResolver);

        register(Constants.AspSchemaResourcePath_22,
                Constants.AspSchemaPublicId_22,
                schemaResolver);
