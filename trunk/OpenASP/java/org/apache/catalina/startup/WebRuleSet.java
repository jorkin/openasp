...
import com.zfbots.openasp.util.IntrospectionUtils;
import com.zfbots.openasp.util.digester.CallMethodRule;
import com.zfbots.openasp.util.digester.CallParamRule;
import com.zfbots.openasp.util.digester.Digester;
import com.zfbots.openasp.util.digester.Rule;
import com.zfbots.openasp.util.digester.RuleSetBase;
import com.zfbots.openasp.util.digester.SetNextRule;
...
public class WebRuleSet extends RuleSetBase {
    ...
    /**
     * The <code>SetAspConfig</code> rule used to parse the web.xml
     */    
    protected SetAspConfig aspConfig = new SetAspConfig();
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addRule(fullPrefix + "/asp-config",
                         aspConfig);

        digester.addObjectCreate(fullPrefix + "/asp-config/asp-property-group",
                                 "org.apache.catalina.deploy.AspPropertyGroup");
        digester.addSetNext(fullPrefix + "/asp-config/asp-property-group",
                            "addAspPropertyGroup",
                            "org.apache.catalina.deploy.AspPropertyGroup");
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/deferred-syntax-allowed-as-literal",
                               "setDeferredSyntax", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/el-ignored",
                               "setElIgnored", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/include-coda",
                               "addIncludeCoda", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/include-prelude",
                               "addIncludePrelude", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/is-xml",
                               "setIsXml", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/page-encoding",
                               "setPageEncoding", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/scripting-invalid",
                               "setScriptingInvalid", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/trim-directive-whitespaces",
                               "setTrimWhitespace", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/url-pattern",
                               "addUrlPattern", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/default-content-type",
                               "setDefaultContentType", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/buffer",
                               "setBuffer", 0);
        digester.addCallMethod(fullPrefix + "/asp-config/asp-property-group/error-on-undeclared-namespace",
        ...
        digester.addCallMethod(fullPrefix + "/servlet/asp-file",
                               "setAspFile", 0);
        ...
        digester.addRule(fullPrefix + "/asp-config/taglib", new TaglibLocationRule(true));
        digester.addCallMethod(fullPrefix + "/asp-config/taglib",
                "addTaglib", 2);
        digester.addCallParam(fullPrefix + "/asp-config/taglib/taglib-location", 1);
        digester.addCallParam(fullPrefix + "/asp-config/taglib/taglib-uri", 0);
     ...
     */
    public void recycle(){
        aspConfig.isAspConfigSet = false;
...
/**
 * Rule to check that the <code>asp-config</code> is occurring 
 * only 1 time within the web.xml
 */
final class SetAspConfig extends Rule {
    protected boolean isAspConfigSet = false;
    public SetAspConfig() {
        // NO-OP
    }
    ...
    public void begin(String namespace, String name, Attributes attributes)
        ...
        if (isAspConfigSet){
            throw new IllegalArgumentException(
            "<asp-config> element is limited to 1 occurrence");
        }
        isAspConfigSet = true;
    }
