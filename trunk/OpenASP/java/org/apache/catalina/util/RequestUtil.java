...
public final class RequestUtil {
     ...
     *             com.zfbots.openasp.util.http.RequestUtil#normalize(String)} as
     *             a replacement.
     */
    @Deprecated
    public static String normalize(String path) {
        return com.zfbots.openasp.util.http.RequestUtil.normalize(path);
    }
     ...
     * @deprecated Deprecated to resolve a circular package dependency and will
     *             be removed in Tomcat 8.0.x. Use {@link
     *             com.zfbots.openasp.util.http.RequestUtil#normalize(String,
