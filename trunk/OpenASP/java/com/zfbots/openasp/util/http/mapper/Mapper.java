...
package com.zfbots.openasp.util.http.mapper;

import javax.naming.NamingException;
import javax.naming.directory.DirContext;

import com.zfbots.openasp.util.buf.Ascii;
import com.zfbots.openasp.util.buf.CharChunk;
import com.zfbots.openasp.util.buf.MessageBytes;
...
public final class Mapper {
    ...
    public void addWrapper(String hostName, String contextPath, String version,
                           String path, Object wrapper, boolean aspWildCard,
        ...
        if (host.name.equals(hostName)) {
            ...
            if (context.name.equals(contextPath)) {
                ...
                if (contextVersion.name.equals(version)) {
                    addWrapper(contextVersion, path, wrapper, aspWildCard,
                            resourceOnly);
                }
            }
        }
    ...
    public void addWrapper(String path, Object wrapper, boolean aspWildCard,
            boolean resourceOnly) {
        addWrapper(context, path, wrapper, aspWildCard, resourceOnly);
    }
     ...
     * @param aspWildCard true if the wrapper corresponds to the AspServlet
     * @param resourceOnly true if this wrapper always expects a physical
     *                     resource to be present (such as a JSP)
     * and the mapping path contains a wildcard; false otherwise
     */
    protected void addWrapper(ContextVersion context, String path,
            Object wrapper, boolean aspWildCard, boolean resourceOnly) {

        synchronized (context) {
            Wrapper newWrapper = new Wrapper();
            newWrapper.object = wrapper;
            newWrapper.aspWildCard = aspWildCard;
    ...
    private final void internalMapWrapper(ContextVersion contextVersion,
        ...
        // Rule 2 -- Prefix Match
        boolean checkAspWelcomeFiles = false;
        Wrapper[] wildcardWrappers = contextVersion.wildcardWrappers;
        if (mappingData.wrapper == null) {
            internalMapWildcardWrapper(wildcardWrappers, contextVersion.nesting,
                                       path, mappingData);
            if (mappingData.wrapper != null && mappingData.aspWildCard) {
        ...
        if (mappingData.wrapper == null && !checkAspWelcomeFiles) {
        ...
        if (mappingData.wrapper == null) {
            boolean checkWelcomeFiles = checkAspWelcomeFiles;
    ...
    private final void internalMapWildcardWrapper
        ...
        if (pos != -1) {
            ...
            if (found) {
                ...
                mappingData.wrapper = wrappers[pos].object;
                mappingData.aspWildCard = wrappers[pos].aspWildCard;
            }
        }
    }
    ...
    protected static class Wrapper
        ...
        public boolean aspWildCard = false;
