 ...
 */
package com.zfbots.openasp.util.http.fileupload;
...
import com.zfbots.openasp.util.http.fileupload.MultipartStream.ItemInputStream;
import com.zfbots.openasp.util.http.fileupload.util.Closeable;
import com.zfbots.openasp.util.http.fileupload.util.FileItemHeadersImpl;
import com.zfbots.openasp.util.http.fileupload.util.LimitedInputStream;
 ...
 * com.zfbots.openasp.util.http.fileupload.FileItem}s associated with a given HTML
 * widget.</p>
 *
    ...
    public List<FileItem> parseRequest(RequestContext ctx)
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                final String fileName = ((com.zfbots.openasp.util.http.fileupload.FileUploadBase.FileItemIteratorImpl.FileItemStreamImpl) item).name;
