...
public interface Tag extends AspTag {
     ...
     * the body (if any) is included into the current "out" AspWriter as it
     ...
     * @throws AspException if an error occurred while processing this tag
     * @see BodyTag
     */
 
    int doStartTag() throws AspException;
    ...
    int doEndTag() throws AspException;
