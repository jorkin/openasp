 ...
 * <p>
 * As of JSP 2.0, a JSP container must support a asp:id attribute to provide
 ...
 * is passed as the value of the asp:id attribute. Each XML element in the XML
 ...
 * <code>asp</code> but it will always map to the namespace
...
public class ValidationMessage {
     ...
     * element, or if no asp:id attributes were passed on. If non-null, the
     * value of id must be the value of a asp:id attribute for the PageData
     * passed into the validate() method.
     * 
     * @param id
     *            Either null, or the value of a asp:id attribute.
     * @param message
    ...
    /**
     * Get the asp:id. Null means that there is no information available.
     * 
     * @return The asp:id information.
     */
    public String getId() {
        return id;
    }
