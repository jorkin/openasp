...
/**
 * <p>
 * <code>AspContext</code> serves as the base class for the 
 ...
 * <p>
 * The following methods enable the <B>management of nested</B> AspWriter 
...
public abstract class AspContext {
    ...
    /**
     * The current value of the out object (a AspWriter).
     *
     * @return the current AspWriter stream being used for client response
     */
    public abstract AspWriter getOut();
     ...
     *             AspApplicationContext.getExpressionFactory()
     */
    @SuppressWarnings("dep-ann") // TCK signature test fails with annotation
    public abstract javax.servlet.asp.el.ExpressionEvaluator getExpressionEvaluator();
     ...
     * implicit objects specified in the JSP specification using this AspContext
     ...
     *             aspContext.getELContext().getELResolver()
     */
    @SuppressWarnings("dep-ann") // TCK signature test fails with annotation
    public abstract javax.servlet.asp.el.VariableResolver getVariableResolver();
    
    /**
     * Return a new AspWriter object that sends output to the
     * provided Writer.  Saves the current "out" AspWriter,
     * and updates the value of the "out" attribute in the
     * page scope attribute namespace of the AspContext.
     * <p>The returned AspWriter must implement all methods and
     ...
     * </p>
     *
     * @param writer The Writer for the returned AspWriter to send
     *     output to.
     * @return a new AspWriter that writes to the given Writer.
     * @since 2.0
     */
    public AspWriter pushBody( java.io.Writer writer ) {
        return null; // XXX to implement
    }
    
    /**
     * Return the previous AspWriter "out" saved by the matching
     * pushBody(), and update the value of the "out" attribute in
     * the page scope attribute namespace of the AspContext.
     *
     * @return the saved AspWriter.
     */
