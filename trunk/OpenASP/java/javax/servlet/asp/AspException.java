 ...
 * AspExceptions will result in an invocation of the errorpage
 * machinery.
 */
public class AspException extends Exception {
     ...
     *              message
     */
    public AspException(String msg) {
        super(msg);
    }
    ...
    public AspException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public AspException(Throwable cause) {
        super(cause);
    }
