 ...
 * in an error page.
 */
public class AspTagException extends AspException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new AspTagException with the specified message. The message
     ...
     *            message
     */
    public AspTagException(String msg) {
        super(msg);
    }

    /**
     * Constructs a new AspTagException with no message.
     */
    public AspTagException() {
        super();
    }

    /**
     * Constructs a new AspTagException when the JSP Tag needs to throw an
     ...
     * @since 2.0
     */
    public AspTagException(String message, Throwable rootCause) {
     ...
     * When subclassing <code>AspTagException</code>, this method can be
     ...
     * @since 2.0
     */
    public AspTagException(Throwable rootCause) {
        super(rootCause);
    }
}
