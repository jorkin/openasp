...
/**
 * <p>
 * The AspFactory is an abstract class that defines a number of factory
 ...
 * <p>
 * The PageContext and the AspEngineInfo classes are the only
 * implementation-dependent classes that can be created from the factory.
 * <p>
 * AspFactory objects should not be used by JSP page authors.
 */

public abstract class AspFactory {

    private static volatile AspFactory deflt = null;
    ...
    public static void setDefaultFactory(AspFactory deflt) {
        AspFactory.deflt = deflt;
    }
    ...
    public static AspFactory getDefaultFactory() {
        return deflt;
    }
     ...
     * javax.servlet.asp.PageContext abstract class for the calling Servlet
     * and currently pending request and response.
     * </p>
     *
     * <p>
     * This method is typically called early in the processing of the 
     * _aspService() method of a JSP implementation class in order to 
     ...
     *
     * @see javax.servlet.asp.PageContext
     */
     ...
     * This method should be invoked prior to returning from the _aspService()
     ...
     * </p>
     *
     * @return a AspEngineInfo object describing the current JSP engine
     */
    
    public abstract AspEngineInfo getEngineInfo();
    
    /**
     * <p>
     * Obtain the <code>AspApplicationContext</code> instance that was
     ...
     * @return <code>AspApplicationContext</code> instance
     * @since 2.1
     */
    public abstract AspApplicationContext getAspApplicationContext(
