...
/**
 * The AspPage interface describes the generic interaction that a asp Page
 * Implementation class must satisfy; pages that use the HTTP protocol
 * are described by the HttpAspPage interface.
 *
 * <p><B>Two plus One Methods</B>
 * <p>
 * The interface defines a protocol with 3 methods; only two of
 * them: aspInit() and aspDestroy() are part of this interface as
 * the signature of the third method: _aspService() depends on
 ...
 * <p>
 * The aspInit() and aspDestroy() methods can be defined by a JSP
 * author, but the _aspService() method is defined automatically
 * by the JSP processor based on the contents of the JSP page.
 *
 * <p><B>_aspService()</B>
 * <p>
 * The _aspService()method corresponds to the body of the JSP page. This
 ...
 * before or after calling the _aspService() method.  See using the extends
 ...
 *
 * <pre>
 * public void _aspService(<em>ServletRequestSubtype</em> request,
...
public interface AspPage extends Servlet {

    /**
     * The aspInit() method is invoked when the JSP page is initialized. It
    ...
    /**
     * The aspDestroy() method is invoked when the JSP page is about to be
     * destroyed.
     * 
     * A JSP page can override this method by including a definition for it
     * in a declaration element.
